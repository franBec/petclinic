# Petclinic Kt Gradle Thymeleaf Tailwind Webpack Htmx Ts
...
```
java -Dspring.profiles.active=production -jar ./build/libs/petclinic-kt-gradle-thymeleaf-tailwind-webpack-htmx-ts-0.0.1-SNAPSHOT.jar
```
...
```
gradlew bootBuildImage --imageName=dev.pollito/petclinic-kt-gradle-thymeleaf-tailwind-webpack-htmx-ts
```
