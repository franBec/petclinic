# Petclinic Java Gradle React Tailwind Ts
...
```
java -Dspring.profiles.active=production -jar ./build/libs/petclinic-java-gradle-react-tailwind-ts-0.0.1-SNAPSHOT.jar
```
...
```
gradlew bootBuildImage --imageName=dev.pollito/petclinic-java-gradle-react-tailwind-ts
```
